...
- **Interactive Sidebar**: Real-time searching and dynamic hierarchy management via `sidebar.json`.
- **Custom Audio Integration**: Built-in sound catalog playback for in-game sound asset previews.
...
2. Run a local web server (e.g., `python -m http.server 8080`) from the project root.
